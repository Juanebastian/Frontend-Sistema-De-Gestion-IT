  ...
  readonly navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/users/roles', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', label: 'Roles y permisos' }
      ]
    },
    {
      path: '/products',
      ...
      label: 'Equipos',
      children: [
        { path: '/products/list', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16', label: 'Todos los equipos' },
        { path: '/products/categories', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z', label: 'Categorías' },
        { path: '/products/inventory', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', label: 'Inventario' }
      ]
    },
    {
      path: '/orders',
